...
\fl{}\moduleLeftDash\cl{ {\MODULE} FridjappImpl}\moduleRightDash\cl{}
\fl{}
\fl{ {\EXTENDS} Integers ,\, FiniteSets ,\, Sequences}
\fl{}
\fl{ {\CONSTANTS} INGREDIENT\_TYPES ,\, MAX\_QTTY ,\, USERS ,\, EMPTY}
\fl{}
\fl{ {\VARIABLES} userData ,\, msgs}
\fl{}
\fl{ PT \.{\defeq} {\INSTANCE} PT}
\fl{}
\fl{}
\fl{}\al{11}{0}{}
\fl{}\al{12}{0}{}
 \fl{ Sum ( fun ) \.{\defeq} PT {\bang} ReduceSet (}\al{13}{9}{ {\LAMBDA} k
 ,\, acc \.{:} acc \.{+} fun [ k ] ,\,}
\fl{ {\DOMAIN} fun ,\, 0 )}
\fl{}
\fl{}
\fl{}\al{17}{0}{}
\fl{}\al{18}{0}{}
\fl{ SHOP}\al{19}{1}{ \.{\defeq}}\al{19}{2}{\@w{shop}}\al{19}{3}{%
\@y{\@s{0}%
 shopping list
}%
}
\fl{ FRDJ}\al{20}{1}{ \.{\defeq}}\al{20}{2}{\@w{frdj}}\al{20}{3}{%
\@y{\@s{0}%
 fridj
}%
}
...
\fl{}\al{24}{0}{}
\fl{}\al{25}{0}{}
\fl{ UserData ( data ) \.{\defeq}}
\fl{ \.{\land}}\al{27}{1}{ {\DOMAIN} data \.{=} USERS}
\fl{ \.{\land}}\al{28}{1}{ \A\, u \.{\in} {\DOMAIN} data \.{:}}
\fl{ \.{\lor}}\al{29}{1}{ data [ u ] \.{=} EMPTY}
 \fl{ \.{\lor}}\al{30}{1}{ \.{\land}}\al{30}{2}{ {\DOMAIN} data [ u ]
 \.{\subseteq} Nat}
\fl{ \.{\land}}\al{31}{1}{ \A\, f \.{\in} {\DOMAIN} data [ u ] \.{:}}
 \fl{ data [ u ] [ f ] \.{\in} [}\al{32}{9}{ frdj}\al{32}{10}{
 \.{:}}\al{32}{11}{ [ INGREDIENT\_TYPES}\al{32}{13}{
 \.{\rightarrow}}\al{32}{14}{ Nat ] ,\,}
 \fl{ shop}\al{33}{1}{ \.{:}}\al{33}{2}{ [ INGREDIENT\_TYPES}\al{33}{4}{
 \.{\rightarrow}}\al{33}{5}{ Nat ] ,\,}
\fl{ cnt \.{:} Nat ,\,}
\fl{ sync \.{:} {\SUBSET} USERS ,\,}
\fl{ owner \.{:} USERS ]}
\fl{}
\fl{}
\fl{}\al{39}{0}{}
...
\fl{}\al{41}{0}{}
\fl{}\al{42}{0}{}
\fl{ Msgs}\al{43}{1}{ ( messages ) \.{\defeq}}
\fl{ \.{\land}}\al{44}{1}{ {\DOMAIN} messages \.{=} USERS}
\fl{ \.{\land}}\al{45}{1}{ \A\, u \.{\in} {\DOMAIN} messages \.{:}}
\fl{ \.{\lor}}\al{46}{1}{ messages [ u ] \.{=} {\langle} {\rangle}}
 \fl{ \.{\lor}}\al{47}{1}{ PT {\bang} ReduceSeq (}\al{47}{5}{ {\LAMBDA} m ,\,
 acc \.{:}}
\fl{ \.{\land}}\al{48}{1}{ acc}
 \fl{ \.{\land}}\al{49}{1}{ m \.{\in} [}\al{49}{4}{ user}\al{49}{5}{
 \.{:}}\al{49}{6}{ USERS ,\,}
\fl{ type}\al{50}{1}{ \.{:}}\al{50}{2}{ \{ FRDJ ,\, SHOP \} ,\,}
\fl{ frdjId \.{:} Nat ,\,}
\fl{ val \.{:} [ INGREDIENT\_TYPES \.{\rightarrow} Nat ] ] ,\,}
\fl{ messages [ u ] ,\, {\TRUE} )}
\fl{}
\fl{}
\fl{}\al{56}{0}{}
\fl{}\al{57}{0}{}
\fl{ TypeOK}\al{58}{1}{ \.{\defeq}}
\fl{ \.{\land}}\al{59}{1}{ UserData ( userData )}
\fl{ \.{\land}}\al{60}{1}{ Msgs ( msgs )}
\fl{}
\fl{}
\fl{}\al{63}{0}{}
\fl{}\al{64}{0}{}
\fl{ vars \.{\defeq} {\langle} userData ,\, msgs {\rangle}}
\fl{}
\fl{}
\fl{}\al{68}{0}{}
\fl{}\al{69}{0}{}
\fl{ Msg (}\al{70}{2}{ user ,\, type ,\, frdjId ,\, new\_val ) \.{\defeq}}
\fl{ [}\al{71}{1}{ user}\al{71}{2}{ \.{\mapsto}}\al{71}{3}{ user ,\,}
\fl{ type}\al{72}{1}{ \.{\mapsto}}\al{72}{2}{ type ,\,}
\fl{ frdjId \.{\mapsto} frdjId ,\,}
\fl{ val \.{\mapsto} new\_val ]}
\fl{}
\fl{}
\fl{}\al{77}{0}{}
\fl{}\al{78}{0}{}
\fl{ Send}\al{79}{1}{ ( from ,\, new\_msgs ) \.{\defeq}}
 \fl{ msgs \.{'} \.{=} [ msgs {\EXCEPT} {\bang} [ from ] \.{=} @ \.{\circ}
 new\_msgs ]}
\fl{}
\fl{}
\fl{}\al{83}{0}{}
\fl{}\al{84}{0}{}
 \fl{ AllIds \.{\defeq} PT {\bang} ReduceSet (}\al{85}{6}{ {\LAMBDA} u ,\, a
 \.{:}}
\fl{ {\IF} userData [ u ] \.{=} EMPTY}
\fl{ \.{\THEN} a}
\fl{ \.{\ELSE} a \.{\cup} {\DOMAIN} userData [ u ] ,\,}
\fl{ USERS ,\, \{ \} )}
\fl{ Ids ( user ) \.{\defeq}}\al{90}{5}{ {\IF} userData [ user ] \.{=} EMPTY}
\fl{ \.{\THEN} \{ \}}
\fl{ \.{\ELSE} {\DOMAIN} userData [ user ]}
\fl{}
\fl{}
\fl{}\al{95}{0}{}
\fl{}\al{96}{0}{}
\fl{}\al{97}{0}{}
 \fl{ NewFridj ( user ) \.{\defeq} [}\al{98}{6}{ frdj}\al{98}{7}{
 \.{\mapsto}}\al{98}{8}{ [ t}\al{98}{10}{ \.{\in}}\al{98}{11}{
 INGREDIENT\_TYPES}\al{98}{12}{ \.{\mapsto}}\al{98}{13}{ 0 ] ,\,}
 \fl{ shop}\al{99}{1}{ \.{\mapsto}}\al{99}{2}{ [ t}\al{99}{4}{
 \.{\in}}\al{99}{5}{ INGREDIENT\_TYPES}\al{99}{6}{ \.{\mapsto}}\al{99}{7}{ 0
 ] ,\,}
\fl{ cnt \.{\mapsto} 0 ,\,}
\fl{ owner \.{\mapsto} user ,\,}
\fl{ sync \.{\mapsto} \{ \} ]}
\fl{}
 \fl{ AddFridj ( user ,\, id ,\, frdjData ) \.{\defeq} [}\al{104}{10}{ x
 \.{\in} Ids ( user ) \.{\cup} \{ id \} \.{\mapsto}}
\fl{ {\IF} x \.{=} id}
\fl{ \.{\THEN} frdjData}
\fl{ \.{\ELSE} userData [ user ] [ x ] ]}
\fl{}
\fl{ CreateFridj ( user ) \.{\defeq}}
 \fl{ \.{\land}}\al{110}{1}{ \E\,}\al{110}{2}{ id \.{\in} Nat
 \.{\,\backslash\,} AllIds \.{:}}
 \fl{ userData \.{'} \.{=} [ userData {\EXCEPT} {\bang} [ user ] \.{=}
 AddFridj ( user ,\, id ,\, NewFridj ( user ) ) ]}
\fl{ \.{\land}}\al{112}{1}{ {\UNCHANGED} msgs}
\fl{}
\fl{ DeleteFridj ( user ) \.{\defeq} \E\, id \.{\in} Ids ( user ) \.{:}}
\fl{ \.{\land}}\al{115}{1}{ userData [ user ] [ id ] . owner \.{=} user}
 \fl{ \.{\land}}\al{116}{1}{ userData \.{'} \.{=} [ userData {\EXCEPT} {\bang}
 [ user ] \.{=} [ x \.{\in} Ids ( user ) \.{\,\backslash\,} \{ id \}
 \.{\mapsto} @ [ x ] ] ]}
\fl{ \.{\land}}\al{117}{1}{ {\UNCHANGED} msgs}
\fl{}
 \fl{ Subscribe ( user ) \.{\defeq} \E\, u \.{\in} USERS \.{\,\backslash\,} \{
 user \} \.{:} \E\, id \.{\in} Ids ( u ) \.{:}}
\fl{ \.{\land}}\al{120}{1}{ userData [ u ] [ id ] . owner \.{=} u}
 \fl{ \.{\land}}\al{121}{1}{ userData \.{'} \.{=} [ userData
 {\EXCEPT}}\al{121}{7}{ {\bang}}\al{121}{8}{ [ u ] [ id ] . sync \.{=} @
 \.{\cup} \{ user \} ,\,}
 \fl{ {\bang}}\al{122}{1}{ [ user ] \.{=} AddFridj ( user ,\, id ,\, userData
 [ u ] [ id ] ) ]}
\fl{ \.{\land}}\al{123}{1}{ {\UNCHANGED} msgs}
\fl{}
\fl{ Unsubscribe ( user ) \.{\defeq} \E\, id \.{\in} Ids ( user ) \.{:}}
\fl{ \.{\land}}\al{126}{1}{ userData [ user ] [ id ] . owner \.{\neq} user}
 \fl{ \.{\land}}\al{127}{1}{ userData \.{'} \.{=} [ u}\al{127}{6}{ \.{\in}
 USERS \.{\mapsto}}
\fl{ {\IF} u \.{=} user}
 \fl{ \.{\THEN} [ uid}\al{129}{3}{ \.{\in}}\al{129}{4}{ Ids ( u )
 \.{\,\backslash\,} \{ id \}}\al{129}{12}{ \.{\mapsto} userData [ u ] [ uid ]
 ]}
 \fl{ \.{\ELSE} [}\al{130}{2}{ uid}\al{130}{3}{ \.{\in}}\al{130}{4}{ Ids ( u
 )}\al{130}{8}{ \.{\mapsto}}
\fl{ [}\al{131}{1}{ userData [ u ] [ uid ] {\EXCEPT} {\bang} . sync \.{=}}
 \fl{ {\IF} uid \.{=} id}\al{132}{4}{ \.{\THEN} @ \.{\,\backslash\,} \{ user
 \}}
\fl{ \.{\ELSE} @ ] ] ]}
\fl{ \.{\land}}\al{134}{1}{ {\UNCHANGED} msgs}
\fl{}
\fl{}
\fl{}\al{137}{0}{}
\fl{}\al{138}{0}{}
\fl{ AddToShoppingList ( user ) \.{\defeq}}
 \fl{ \E\,}\al{140}{1}{ t \.{\in} INGREDIENT\_TYPES ,\, id \.{\in} Ids ( user
 ) \.{:}}
\fl{}
 \fl{ \.{\LET} \_userData \.{\defeq} [ userData {\EXCEPT} {\bang} [ user ] [
 id ] . shop [ t ] \.{=} @ \.{+} 1 ]}
 \fl{ \.{\IN}}\al{143}{1}{ \.{\land}}\al{143}{2}{ userData \.{'} \.{=}
 \_userData}
 \fl{ \.{\land}}\al{144}{1}{ Send ( user ,\, {\langle} Msg ( user ,\, SHOP ,\,
 id ,\, \_userData [ user ] [ id ] . shop ) {\rangle} )%
\@y{\@s{0}%
 \ensuremath{TODO} must send to subcribed users
}%
}
\fl{}
\fl{}
\fl{}\al{147}{0}{}
\fl{}\al{148}{0}{}
\fl{ BuyIngredients ( user ) \.{\defeq}}
 \fl{ \E\,}\al{150}{1}{ t \.{\in} INGREDIENT\_TYPES ,\, id \.{\in} Ids ( user
 ) \.{:}}
\fl{}
\fl{ \.{\LET}}\al{152}{1}{ data \.{\defeq} userData [ user ] [ id ]}
\fl{}
 \fl{ bought\_n \.{\defeq} PT {\bang} Min ( MAX\_QTTY \.{-} data . frdj [ t ]
 ,\, data . shop [ t ] )}
 \fl{ \_userData \.{\defeq} [ userData {\EXCEPT}}\al{155}{5}{
 {\bang}}\al{155}{6}{ [ user ] [ id ] . shop [ t ]}\al{155}{17}{
 \.{=}}\al{155}{18}{ @}\al{155}{19}{ \.{-}}\al{155}{20}{ bought\_n ,\,}
 \fl{ {\bang}}\al{156}{1}{ [ user ] [ id ] . frdj [ t ]}\al{156}{12}{
 \.{=}}\al{156}{13}{ @}\al{156}{14}{ \.{+}}\al{156}{15}{ bought\_n ]}
\fl{ \.{\IN}}\al{157}{1}{ \.{\land}}\al{157}{2}{ bought\_n \.{>} 0}
\fl{ \.{\land}}\al{158}{1}{ userData \.{'} \.{=} \_userData}
 \fl{ \.{\land}}\al{159}{1}{ Send ( user ,\, {\langle}}\al{159}{6}{ Msg ( user
 ,\, SHOP ,\, id ,\, \_userData [ user ] [ id ] . shop ) ,\,}
 \fl{ Msg ( user ,\, FRDJ ,\, id ,\, \_userData [ user ] [ id ] . frdj )
 {\rangle} )%
\@y{\@s{0}%
 \ensuremath{TODO} must send to subcribed users
}%
...
\fl{}\al{164}{0}{}
\fl{ AllRecipes \.{\defeq}}
 \fl{ [ INGREDIENT\_TYPES \.{\rightarrow} 0 \.{\dotdot} MAX\_QTTY ]
 \.{\,\backslash\,} \{ [ t \.{\in} INGREDIENT\_TYPES \.{\mapsto} 0 ] \}}
\fl{}
\fl{ MakeRecipe ( user ) \.{\defeq}}
\fl{ \E\,}\al{169}{1}{ r \.{\in} AllRecipes ,\, id \.{\in} Ids ( user ) \.{:}}
 \fl{ \.{\LET} \_userData \.{\defeq} [ userData {\EXCEPT}}\al{170}{6}{
 {\bang}}\al{170}{7}{ [ user ] [ id ] . frdj \.{=} [ t \.{\in} {\DOMAIN} @
 \.{\mapsto} @ [ t ] \.{-} r [ t ] ] ,\,}
\fl{ {\bang}}\al{171}{1}{ [ user ] [ id ] . cnt \.{=} @ \.{+} 1 ]}
 \fl{ \.{\IN}}\al{172}{1}{ \.{\land}}\al{172}{2}{ \A\, t \.{\in} {\DOMAIN} r
 \.{:} userData [ user ] [ id ] . frdj [ t ] \.{\geq} r [ t ]}
\fl{ \.{\land}}\al{173}{1}{ userData \.{'} \.{=} \_userData}
 \fl{ \.{\land}}\al{174}{1}{ Send ( user ,\, {\langle} Msg ( user ,\, FRDJ ,\,
 id ,\, \_userData [ user ] [ id ] . frdj ) {\rangle} )%
\@y{\@s{0}%
 \ensuremath{TODO} must send to subcribed users
}%
}
\fl{}
\fl{ RcvMsg ( user ) \.{\defeq}}
\fl{ \.{\land}}\al{177}{1}{ msgs [ user ] \.{\neq} {\langle} {\rangle}}
\fl{ \.{\land}}\al{178}{1}{ \.{\LET} msg \.{\defeq} Head ( msgs [ user ] )}
 \fl{ \.{\IN} userData \.{'} \.{=}}\al{179}{4}{ {\CASE}}\al{179}{5}{ msg .
 type}\al{179}{8}{ \.{=}}\al{179}{9}{ FRDJ}\al{179}{10}{
 \.{\rightarrow}}\al{179}{11}{ [ userData {\EXCEPT} {\bang} [ user ] [ msg .
 frdjId ] . frdj}\al{179}{25}{ \.{=}}\al{179}{26}{ msg . val ]}
 \fl{ {\Box}}\al{180}{1}{ msg . type}\al{180}{4}{ \.{=}}\al{180}{5}{
 SHOP}\al{180}{6}{ \.{\rightarrow}}\al{180}{7}{ [ userData {\EXCEPT} {\bang}
 [ user ] [ msg . frdjId ] . shop}\al{180}{21}{ \.{=}}\al{180}{22}{ msg . val
 ]}
 \fl{ \.{\land}}\al{181}{1}{ msgs \.{'} \.{=} [ msgs {\EXCEPT} {\bang} [ user
 ]}\al{181}{11}{ \.{=} Tail ( @ ) ]}
\fl{}
\fl{}
\fl{}\al{184}{0}{}
\fl{}\al{185}{0}{}
\fl{ Next \.{\defeq}}
\fl{ \E\,}\al{187}{1}{ u \.{\in} USERS \.{:}}
\fl{ \.{\lor}}\al{188}{1}{ Unsubscribe ( u )}
\fl{ \.{\lor}}\al{189}{1}{ AddToShoppingList ( u )}
\fl{ \.{\lor}}\al{190}{1}{ BuyIngredients ( u )}
\fl{ \.{\lor}}\al{191}{1}{ MakeRecipe ( u )}
\fl{ \.{\lor}}\al{192}{1}{ RcvMsg ( u )}
\fl{ \.{\lor}}\al{193}{1}{ CreateFridj ( u )}
\fl{ \.{\lor}}\al{194}{1}{ DeleteFridj ( u )}
\fl{ \.{\lor}}\al{195}{1}{ Subscribe ( u )}
\fl{}
\fl{ Init \.{\defeq}}
 \fl{ \.{\land}}\al{198}{1}{ userData \.{=} [ u \.{\in} USERS \.{\mapsto}
 EMPTY ]}
 \fl{ \.{\land}}\al{199}{1}{ msgs \.{=} [ u \.{\in} USERS \.{\mapsto}
 {\langle} {\rangle} ]}
\fl{}
...
\fl{}\al{205}{0}{}
\fl{ FairSpec \.{\defeq}}
\fl{ \.{\land}}\al{207}{1}{ Spec}
 \fl{ \.{\land}}\al{208}{1}{ \A\, u \.{\in} USERS \.{:}}\al{208}{6}{
 \.{\land}}\al{208}{7}{ {\SF}_{ vars} ( CreateFridj ( u ) )}
\fl{ \.{\land}}\al{209}{1}{ {\SF}_{ vars} ( DeleteFridj ( u ) )}
\fl{ \.{\land}}\al{210}{1}{ {\SF}_{ vars} ( Subscribe ( u ) )}
\fl{ \.{\land}}\al{211}{1}{ {\SF}_{ vars} ( Unsubscribe ( u ) )}
\fl{ \.{\land}}\al{212}{1}{ {\SF}_{ vars} ( BuyIngredients ( u ) )}
\fl{ \.{\land}}\al{213}{1}{ {\SF}_{ vars} ( MakeRecipe ( u ) )}
\fl{ \.{\land}}\al{214}{1}{ {\SF}_{ vars} ( AddToShoppingList ( u ) )}
\fl{ \.{\land}}\al{215}{1}{ {\SF}_{ vars} ( RcvMsg ( u ) )}
\fl{}
\fl{}
\fl{}\al{218}{0}{}
\fl{}\al{219}{0}{}
\fl{}\al{220}{0}{}
\fl{ NoMsgForUnsubscribedUser \.{\defeq} \A\, u \.{\in} USERS \.{:}}
 \fl{ PT {\bang} ReduceSeq (}\al{222}{4}{ {\LAMBDA} m ,\, acc \.{:} acc
 \.{\land} m . frdjId \.{\in} {\DOMAIN} userData [ u ] ,\,}
\fl{ msgs [ u ] ,\, {\TRUE}%
\@y{%
 all messages ref an existing \ensuremath{frdjId
}}%
 )}
\fl{}
\fl{}
\fl{}\al{226}{0}{}
\fl{}\al{227}{0}{}
 \fl{ AllUsersMakeRecipes \.{\defeq} \A\, u \.{\in} USERS \.{:} {\Diamond} (
 \A\, id \.{\in} Ids ( u ) \.{:} userData [ u ] [ id ] . cnt \.{>} 0 )}
 \fl{ FridjesCreated \.{\defeq} \A\, u \.{\in} USERS \.{:} {\Diamond} (
 userData [ u ] \.{\neq} EMPTY )}
\fl{ UserDataIsSynchronized \.{\defeq}}
 \fl{ \.{\land} {\Diamond} ( \E\, u \.{\in} USERS \.{:} msgs [ u ] \.{\neq}
 {\langle} {\rangle} )}
\fl{}
 \fl{ \.{\land} \A\, u \.{\in} USERS \.{:} msgs [ u ] \.{\neq} {\langle}
 {\rangle} \.{\leadsto} msgs [ u ] \.{=} {\langle} {\rangle}}
\fl{}
 \fl{ \.{\land}}\al{235}{1}{ \A\, id \.{\in} AllIds \.{:} \E\, owner \.{\in}
 USERS \.{:}}
\fl{ \.{\land}}\al{236}{1}{ userData [ owner ] [ id ] . owner \.{=} owner}
 \fl{ \.{\land}}\al{237}{1}{ \A\, u \.{\in} USERS \.{\,\backslash\,} \{ owner
 \} \.{:}}
\fl{ \.{\land}}\al{238}{1}{ u \.{\in} userData [ owner ] [ id ] . sync}
 \fl{ \.{\land}}\al{239}{1}{ userData [ u ] [ id ] . frdj}\al{239}{10}{
 \.{=}}\al{239}{11}{ userData [ owner ] [ id ] . frdj}
 \fl{ \.{\land}}\al{240}{1}{ userData [ u ] [ id ] . shop}\al{240}{10}{
 \.{=}}\al{240}{11}{ userData [ owner ] [ id ] . shop}
\fl{}
\fl{}\bottombar\cl{}
\fl{}
\fl{}
