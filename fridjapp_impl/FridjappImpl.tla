...
Next == 
    \E u \in USERS:  
        \/ RunAction("Unsubscribe", u)
        \/ RunAction("AddToShoppingList", u) 
        \/ RunAction("BuyIngredients", u) 
        \/ RunAction("MakeRecipe", u)
        \/ RunAction("RcvMsg", u)
        \/ RunAction("CreateFridj", u)
        \/ RunAction("DeleteFridj", u)
        \/ RunAction("Subscribe", u)
...
\* Last modified Fri Aug 23 01:22:09 CEST 2024 by Davd
