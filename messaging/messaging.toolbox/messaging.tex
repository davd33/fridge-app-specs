...
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Naturals ,\, PT ,\, FiniteSets}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The \ensuremath{messaging} in the fridjapp needs to ensure a coherence in the
 data.
...
\@x{ {\CONSTANTS} DEVICES ,\,}%
\@y{\@s{0}%
 contains synchronizing devices
}%
\@xx{}%
\@x{\@s{54.75} DATA ,\,\@s{18.59}}%
\@y{\@s{0}%
 all possible data values
}%
\@xx{}%
\@x{\@s{54.75} LEAD\@s{23.51}}%
\@y{\@s{0}%
 the creator of the fridj has precedence
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\ASSUME} LEAD \.{\in} DEVICES}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} fridjs ,\, msgs ,\, network}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} fridjs ,\, msgs ,\, network {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The fridj\mbox{'}s data is represented by some element in the set
 \ensuremath{DATA}.
\end{cpar}%
\end{lcom}%
\@x{ FridjValue \.{\defeq} [ v\@s{0.46} \.{:} Nat ,\,\@s{7.63}}%
\@y{\@s{0}%
 version
}%
\@xx{}%
\@x{\@s{67.93} d \.{:} DATA ]}%
\@y{\@s{0}%
 some data (could be an ingredient item)
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Fridj \.{\defeq} [ DEVICES \.{\rightarrow} FridjValue ]}%
\@pvspace{8.0pt}%
\@x{ FridjInv \.{\defeq} fridjs \.{\in} Fridj}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 All messages ever sent are added to the \ensuremath{msgs}. Messages not yet
 sent
 can be modified by the sending device.
\end{cpar}%
\end{lcom}%
\@x{ Msg \.{\defeq} [ to \.{:} DEVICES ,\,}%
\@y{\@s{0}%
 device receiving the message
}%
\@xx{}%
\@x{\@s{40.20} from \.{:} DEVICES ,\,}%
\@x{\@s{40.20} sent\@s{2.24} \.{:} {\BOOLEAN} ,\,}%
\@y{\@s{0}%
 true iff to and from are in the network
}%
\@xx{}%
\@x{\@s{40.20} type\@s{2.69} \.{:} \{\@w{synch} ,\,\@w{conn} \} ,\,}%
\@y{\@s{0}%
 either a connection or \ensuremath{synch
}}%
\@xx{}%
\@x{\@s{40.20} data\@s{1.40} \.{:} FridjValue ]}%
\@pvspace{8.0pt}%
\@x{ MsgInv \.{\defeq} msgs \.{\subseteq} Msg}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ Network \.{\defeq} {\SUBSET} DEVICES}%
\@pvspace{8.0pt}%
\@x{ NetworkInv \.{\defeq} network \.{\in} Network}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ FirstVersion \.{\defeq} \E\, n \.{:} n \.{\in} Nat}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Compute the maximum version of the fridj by looking at each instance\mbox{'}s
 version.
\end{cpar}%
\end{lcom}%
\@x{ LattestVersion \.{\defeq} ReduceSet (}%
\@x{\@s{16.4} {\LAMBDA} d ,\, v \.{:} Max ( fridjs [ d ] . v ,\, v ) ,\,}%
\@x{\@s{16.4} DEVICES ,\, FirstVersion )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
What a \ensuremath{synch} version and data value means: nothing.
\end{cpar}%
\end{lcom}%
\@x{ AnyVersion \.{\defeq} FirstVersion}%
\@x{ AnyData \.{\defeq} {\CHOOSE} d \.{\in} DATA \.{:} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Device\mbox{'}s \ensuremath{conn} messages have been sent
\end{cpar}%
\end{lcom}%
\@x{ AllConnMsgsSent ( device ) \.{\defeq}}%
 \@x{\@s{16.4} {\lnot} \E\, msg \.{\in} msgs \.{:} \.{\land} msg . type
 \.{=}\@w{conn}}%
\@x{\@s{91.48} \.{\land} msg . sent}%
\@x{\@s{91.48} \.{\land} msg . from \.{=} device}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
All received \ensuremath{conn} messages have been read.
\end{cpar}%
\end{lcom}%
\@x{ AllConnMsgsRead ( device ) \.{\defeq}}%
 \@x{\@s{16.4} {\lnot} \E\, msg \.{\in} msgs \.{:} \.{\land} msg . type
 \.{=}\@w{conn}}%
\@x{\@s{91.48} \.{\land} msg . sent}%
\@x{\@s{91.48} \.{\land} msg . to \.{=} device}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
All received \ensuremath{synch} messages have been read.
\end{cpar}%
\end{lcom}%
\@x{ AllSynchMsgsRead ( device ) \.{\defeq}}%
 \@x{\@s{16.4} {\lnot} \E\, msg \.{\in} msgs \.{:} \.{\land} msg . type
 \.{=}\@w{synch}}%
\@x{\@s{91.48} \.{\land} msg . sent}%
\@x{\@s{91.48} \.{\land} msg . to \.{=} device}%
...
\end{cpar}%
\end{lcom}%
\@x{ Notify ( devices ,\, version ,\, data ,\, sender ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} msgs \.{'} \.{=} msgs \.{\cup} \{ [ to \.{\mapsto} d
 ,\,}%
\@x{\@s{106.09} from \.{\mapsto} sender ,\,}%
\@x{\@s{106.09} sent\@s{2.24} \.{\mapsto} \.{\land} d \.{\in} network}%
\@x{\@s{142.47} \.{\land} sender \.{\in} network ,\,}%
\@x{\@s{106.09} type\@s{2.69} \.{\mapsto}\@w{synch} ,\,}%
 \@x{\@s{106.09} data\@s{1.40} \.{\mapsto} [ v \.{\mapsto} version ,\, d
 \.{\mapsto} data ] ] \.{:} d \.{\in} devices \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ SendAll ( device ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{7.27} device \.{\in} network}%
 \@x{\@s{16.4} \.{\land}\@s{7.27} msgs \.{'} \.{=} \{ m \.{\in} msgs \.{:} m .
 from \.{\neq} device \.{\lor} m . sent \.{=} {\TRUE} \} \.{\cup}}%
 \@x{\@s{72.70} \{ [ dm {\EXCEPT} {\bang} . sent \.{=} dm . to \.{\in} network
 ] \.{:}}%
 \@x{\@s{94.53} dm \.{\in} \{ m \.{\in} msgs \.{:} m . from \.{=} device
 \.{\land} m . data . v \.{\geq} fridjs [ device ] . v \} \}}%
 \@x{\@s{16.4} \.{\land}\@s{7.27} {\UNCHANGED} {\langle} fridjs ,\, network
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
It\mbox{'}s required to read messages to update the data to a new version.
\end{cpar}%
\end{lcom}%
 \@x{ ReadSynchMsg ( device ) \.{\defeq} \E\, msg \.{\in} \{ m \.{\in} msgs
 \.{:} m . type \.{=}\@w{synch} \} \.{:}}%
\@x{\@s{16.4} \.{\land} msg . to \.{=} device}%
\@x{\@s{16.4} \.{\land} msg . sent}%
\@x{\@s{16.4} \.{\land} msg . data . v \.{\geq} fridjs [ device ] . v}%
 \@x{\@s{16.4} \.{\land} fridjs \.{'} \.{=} [ fridjs {\EXCEPT} {\bang} [
 device ] \.{=} msg . data ]}%
\@x{\@s{16.4} \.{\land} msgs \.{'} \.{=} msgs \.{\,\backslash\,} \{ msg \}}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} network}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ ReadConnMsg ( device ) \.{\defeq} \E\, msg \.{\in} \{ m \.{\in} msgs
 \.{:} m . type \.{=}\@w{conn} \} \.{:}}%
\@x{\@s{16.4} \.{\land} msg . to \.{=} device}%
\@x{\@s{16.4} \.{\land} msg . sent}%
\@x{\@s{16.4} \.{\land} AllSynchMsgsRead ( device )}%
\@x{\@s{16.4} \.{\land} {\IF} msg . data . v \.{\geq} fridjs [ device ] . v}%
 \@x{\@s{27.51} \.{\THEN} \.{\land} fridjs \.{'} \.{=} [ fridjs {\EXCEPT}
 {\bang} [ device ] \.{=} msg . data ]}%
\@x{\@s{58.82} \.{\land} msgs \.{'} \.{=} msgs \.{\,\backslash\,} \{ msg \}}%
 \@x{\@s{27.51} \.{\ELSE} \.{\land} \.{\LET} msg\_sent \.{\defeq} device
 \.{\in} network \.{\land} msg . from \.{\in} network}%
\@x{\@s{90.33} new\_msg \.{\defeq} [ to \.{\mapsto} msg . from ,\,}%
\@x{\@s{152.19} from \.{\mapsto} device ,\,}%
\@x{\@s{152.19} sent\@s{2.24} \.{\mapsto} msg\_sent ,\,}%
\@x{\@s{152.19} type\@s{2.69} \.{\mapsto}\@w{synch} ,\,}%
\@x{\@s{152.19} data\@s{1.40} \.{\mapsto} fridjs [ device ] ]}%
 \@x{\@s{69.93} \.{\IN} msgs \.{'} \.{=} ( msgs \.{\,\backslash\,} \{ msg ,\,
 [ new\_msg {\EXCEPT} {\bang} . sent \.{=} {\FALSE} ] \} )}%
\@x{\@s{128.24} \.{\cup} \{ new\_msg \}}%
\@x{\@s{58.82} \.{\land} {\UNCHANGED} fridjs}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} network}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Update the fridj after the user\mbox{'}s input. Here implemented by a simple
 increment of the counter.
\end{cpar}%
\end{lcom}%
\@x{ FridjUserInput ( device ) \.{\defeq} \E\, dt \.{\in} DATA \.{:}}%
\@x{\@s{16.4} \.{\LET} new\_version \.{\defeq} fridjs [ device ] . v \.{+} 1}%
\@x{\@s{16.4} \.{\IN}}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
 no \ensuremath{synch} to do or new connections to handle
}%
\@xx{}%
 \@x{\@s{32.8} \.{\land} {\lnot} \E\, msg \.{\in} msgs \.{:} msg . to \.{=}
 device \.{\land} msg . sent}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
 wait for \ensuremath{synch} on device\mbox{'}s connection
}%
\@xx{}%
\@x{\@s{32.8} \.{\land} AllConnMsgsSent ( device )}%
 \@x{\@s{32.8} \.{\land} LEAD \.{\in} network \.{\land} device \.{\in}
 network}%
 \@x{\@s{32.8} \.{\land} fridjs \.{'} \.{=} [ fridjs {\EXCEPT} {\bang} [
 device ] \.{=} [ d \.{\mapsto} dt ,\,}%
\@x{\@s{204.77} v\@s{0.46} \.{\mapsto} new\_version ] ]}%
 \@x{\@s{32.8} \.{\land} Notify ( \{ d \.{\in} DEVICES \.{:} d \.{\neq} device
 \} ,\,}%
\@x{\@s{80.54} new\_version ,\,}%
\@x{\@s{80.54} dt ,\,}%
\@x{\@s{80.54} device )}%
\@x{\@s{32.8} \.{\land} {\UNCHANGED} network}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ Connect ( device ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{8.95} device \.{\notin} network}%
 \@x{\@s{16.4} \.{\land}\@s{8.95} network \.{'} \.{=} network \.{\cup} \{
 device \}}%
\@x{\@s{16.4} \.{\land}\@s{8.95} AllSynchMsgsRead ( device )}%
\@x{\@s{16.4} \.{\land}\@s{8.95} AllConnMsgsRead ( device )}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 send \ensuremath{msg} to other connected devices
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} msgs \.{'} \.{=} msgs \.{\cup} \{ [ to \.{\mapsto} d
 ,\,}%
\@x{\@s{106.09} from \.{\mapsto} device ,\,}%
\@x{\@s{106.09} sent\@s{2.24} \.{\mapsto} d \.{\in} network ,\,}%
\@x{\@s{106.09} type\@s{2.69} \.{\mapsto}\@w{conn} ,\,}%
 \@x{\@s{106.09} data\@s{1.40} \.{\mapsto} fridjs [ device ] ] \.{:} d \.{\in}
 network \}}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} fridjs {\rangle}}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ Disconnect ( device ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} device \.{\in} network}%
\@x{\@s{16.4} \.{\land} AllConnMsgsRead ( device )}%
 \@x{\@s{16.4} \.{\land} network \.{'} \.{=} network \.{\,\backslash\,} \{
 device \}}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} msgs ,\, fridjs {\rangle}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ Init \.{\defeq} \E\, dt \.{\in} DATA \.{:}}%
 \@x{\@s{16.4} \.{\land} fridjs\@s{1.35} \.{=} [ d \.{\in} DEVICES \.{\mapsto}
 [ v\@s{0.46} \.{\mapsto} FirstVersion ,\,}%
\@x{\@s{152.61} d \.{\mapsto} dt ] ]}%
\@x{\@s{16.4} \.{\land} msgs \.{=} \{ \}}%
\@x{\@s{16.4} \.{\land} network \.{=} \{ \}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \E\, d \.{\in} DEVICES \.{:}}%
\@x{\@s{16.4} \.{\lor} FridjUserInput ( d )}%
\@x{\@s{16.4} \.{\lor} ReadSynchMsg ( d )}%
\@x{\@s{16.4} \.{\lor} ReadConnMsg ( d )}%
\@x{\@s{16.4} \.{\lor} Connect ( d )}%
\@x{\@s{16.4} \.{\lor} Disconnect ( d )}%
\@x{\@s{16.4} \.{\lor} SendAll ( d )}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\end{lcom}%
\@x{ SynchronizedFridjs \.{\defeq} \A\, d1 ,\, d2 \.{\in} DEVICES \.{:}}%
 \@x{\@s{16.4} fridjs [ d1 ] . v \.{=} fridjs [ d2 ] . v \.{\implies} fridjs [
 d1 ] . d \.{=} fridjs [ d2 ] . d}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{ {\THEOREM} Spec \.{\implies} \.{\land} {\Box} FridjInv}%
\@x{\@s{81.85} \.{\land} {\Box} MsgInv}%
\@x{\@s{81.85} \.{\land} {\Box} NetworkInv}%
\@x{\@s{81.85} \.{\land} {\Box} SynchronizedFridjs}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Oct} 27
 01:09:52 \ensuremath{CEST} 2024 by \ensuremath{davd33
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Oct} 26 14:17:55
 \ensuremath{CEST} 2024 by \ensuremath{davd33
}%
\end{cpar}%
\end{lcom}%
\end{document}
