...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Main}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} TLC ,\, Sequences ,\, FiniteSets ,\, Integers ,\, PT}%
\@x{ {\CONSTANTS} INGREDIENTS ,\, MAX\_QTTY ,\, USERS}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Ingredient records have an type (banana\.{\dots}) and a integer quantity
}%
\@xx{}%
\@x{ AllIngredientSets \.{\defeq}}%
 \@x{\@s{16.4} \{ x \.{\in} ( {\SUBSET} [ type \.{:} INGREDIENTS ,\, qtty
 \.{:} 1 \.{\dotdot} MAX\_QTTY ] ) \.{:}}%
 \@x{\@s{31.34} {\lnot} \E\, i ,\, j \.{\in} x \.{:} i \.{\neq} j \.{\land} i
 . type \.{=} j . type \} \.{\,\backslash\,} \{ \{ \} \}}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{12.29} {\p@mmalgorithm} recettes}%
\@x{ {\p@variables} fridge \.{=} \{ \} ,\,}%
 \@x{\@s{47.76} recipe\_items \.{=} [ u \.{\in} USERS \.{\mapsto} \{ \} ]
 {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@define}}%
\@x{}%
\@y{\@s{0}%
 Recipes with all ingredients available in the \ensuremath{fridge
}}%
\@xx{}%
\@x{ CraftableRecipes \.{\defeq}}%
 \@x{\@s{16.4} \{ r \.{\in} AllIngredientSets \.{:} \A\, item \.{\in} r \.{:}
 \E\, elt \.{\in} fridge \.{:}}%
 \@x{\@s{30.79} item . type \.{=} elt . type \.{\land} item . qtty \.{\leq}
 elt . qtty \}}%
\@pvspace{8.0pt}%
\@x{ EnoughInFridgeForARecipe \.{\defeq}}%
\@x{\@s{16.4} Cardinality ( CraftableRecipes ) \.{>} 0}%
\@pvspace{8.0pt}%
\@x{ NoOtherUserInTheKitchen ( user ) \.{\defeq}}%
 \@x{\@s{16.4} {\lnot} \E\, u \.{\in} USERS \.{:} u \.{\neq} user \.{\land}
 recipe\_items [ u ] \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
\@x{ GetOneRecipe \.{\defeq}}%
\@x{\@s{16.4} {\CHOOSE} r \.{\in} CraftableRecipes \.{:} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{ GetBoughtItems \.{\defeq}}%
\@x{\@s{16.4} {\CHOOSE} is \.{\in} AllIngredientSets \.{:} {\TRUE}}%
\@x{ {\p@end} {\p@define} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@fair} \.{+} {\p@process} client \.{\in} USERS}%
\@x{ {\p@variable} bought\_items \.{=} \{ \} ,\,}%
\@x{\@s{43.22} n\_recipes \.{=} 0 {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@begin} Client\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{16.4} {\p@while} {\TRUE} {\p@do}}%
\@x{\@s{32.8} {\p@either}}%
\@x{\@s{49.19} BuyIngredients\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{49.19} bought\_items \.{:=} GetBoughtItems {\p@semicolon}}%
\@x{\@s{49.19} FillFridge\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{49.19} {\p@while} bought\_items \.{\neq} \{ \} {\p@do}}%
\@x{\@s{65.6} {\p@with} b\_item \.{\in} bought\_items {\p@do}}%
 \@x{\@s{82.0} fridge \.{:=} {\IF} \E\, i \.{\in} fridge \.{:} i . type \.{=}
 b\_item . type}%
 \@x{\@s{123.52} \.{\THEN} \.{\LET} f\_item \.{\defeq} {\CHOOSE} i \.{\in}
 fridge \.{:} i . type \.{=} b\_item . type}%
 \@x{\@s{154.83} \.{\IN} ( fridge \.{\,\backslash\,} \{ f\_item \} ) \.{\cup}
 \{ [ type \.{\mapsto} b\_item . type ,\, qtty \.{\mapsto} f\_item . qtty
 \.{+} b\_item . qtty ] \}}%
\@x{\@s{123.52} \.{\ELSE} fridge \.{\cup} \{ b\_item \} {\p@semicolon}}%
 \@x{\@s{82.0} bought\_items \.{:=} bought\_items \.{\,\backslash\,} \{
 b\_item \} {\p@semicolon}}%
\@x{\@s{65.6} {\p@end} {\p@with} {\p@semicolon}}%
\@x{\@s{49.19} {\p@end} {\p@while} {\p@semicolon}}%
\@x{\@s{32.8} {\p@or}}%
\@x{\@s{49.19} {\p@await} EnoughInFridgeForARecipe {\p@semicolon}}%
\@x{\@s{49.19} ChooseRecipe\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{49.19} {\p@await} EnoughInFridgeForARecipe \.{\land}
 NoOtherUserInTheKitchen ( self ) {\p@semicolon}}%
\@x{\@s{49.19} recipe\_items [ self ] \.{:=} GetOneRecipe {\p@semicolon}}%
\@x{\@s{49.19} MakeRecipe\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{49.19} {\p@while} recipe\_items [ self ] \.{\neq} \{ \} {\p@do}}%
\@x{\@s{65.6} {\p@with} r\_item \.{\in} recipe\_items [ self ] {\p@do}}%
 \@x{\@s{82.0} fridge \.{:=} \.{\LET} f\_item \.{\defeq} {\CHOOSE} i \.{\in}
 fridge \.{:} i . type \.{=} r\_item . type}%
 \@x{\@s{143.92} new\_item \.{\defeq} [ type \.{\mapsto} r\_item . type ,\,
 qtty \.{\mapsto} f\_item . qtty \.{-} r\_item . qtty ]}%
 \@x{\@s{123.52} \.{\IN} ( fridge \.{\,\backslash\,} \{ f\_item \} ) \.{\cup}
 {\IF} new\_item . qtty \.{>} 0 \.{\THEN} \{ new\_item \} \.{\ELSE} \{ \}
 {\p@semicolon}}%
 \@x{\@s{82.0} recipe\_items [ self ] \.{:=} recipe\_items [ self ]
 \.{\,\backslash\,} \{ r\_item \} {\p@semicolon}}%
\@x{\@s{65.6} {\p@end} {\p@with} {\p@semicolon}}%
\@x{\@s{49.19} {\p@end} {\p@while} {\p@semicolon}}%
\@x{\@s{49.19} n\_recipes \.{:=} n\_recipes \.{+} 1 {\p@semicolon}}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{561b9c1c}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{f186b71f}'')
}%
\@xx{}%
\@x{ {\VARIABLES} pc ,\, fridge ,\, recipe\_items}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 define statement
...
\@x{\@s{16.4} {\CHOOSE} is \.{\in} AllIngredientSets \.{:} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} bought\_items ,\, n\_recipes}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} pc ,\, fridge ,\, recipe\_items ,\,
 bought\_items ,\, n\_recipes {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( USERS )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} fridge \.{=} \{ \}}%
 \@x{\@s{35.70} \.{\land} recipe\_items \.{=} [ u \.{\in} USERS \.{\mapsto} \{
 \} ]}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process client
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} bought\_items \.{=} [ self \.{\in} USERS \.{\mapsto}
 \{ \} ]}%
 \@x{\@s{35.70} \.{\land} n\_recipes \.{=} [ self \.{\in} USERS \.{\mapsto} 0
 ]}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet
 \.{\mapsto}\@w{Client} ]}%
\@pvspace{8.0pt}%
\@x{ Client ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{Client}}%
 \@x{\@s{70.36} \.{\land} \.{\lor} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT}
 {\bang} [ self ] \.{=}\@w{BuyIngredients} ]}%
\@x{\@s{81.47} \.{\lor} \.{\land} EnoughInFridgeForARecipe}%
 \@x{\@s{92.58} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ChooseRecipe} ]}%
 \@x{\@s{70.36} \.{\land} {\UNCHANGED} {\langle} fridge ,\, recipe\_items ,\,
 bought\_items ,\, n\_recipes {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ BuyIngredients ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{BuyIngredients}}%
 \@x{\@s{108.86} \.{\land} bought\_items \.{'} \.{=} [ bought\_items {\EXCEPT}
 {\bang} [ self ] \.{=} GetBoughtItems ]}%
 \@x{\@s{108.86} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{FillFridge} ]}%
 \@x{\@s{108.86} \.{\land} {\UNCHANGED} {\langle} fridge ,\, recipe\_items ,\,
 n\_recipes {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ FillFridge ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{FillFridge}}%
\@x{\@s{86.42} \.{\land} {\IF} bought\_items [ self ] \.{\neq} \{ \}}%
 \@x{\@s{109.68} \.{\THEN} \.{\land} \E\, b\_item \.{\in} bought\_items [ self
 ] \.{:}}%
 \@x{\@s{160.30} \.{\land} fridge \.{'} \.{=} ( {\IF} \E\, i \.{\in} fridge
 \.{:} i . type \.{=} b\_item . type}%
 \@x{\@s{216.85} \.{\THEN} \.{\LET} f\_item \.{\defeq} {\CHOOSE} i \.{\in}
 fridge \.{:} i . type \.{=} b\_item . type}%
 \@x{\@s{248.17} \.{\IN} ( fridge \.{\,\backslash\,} \{ f\_item \} ) \.{\cup}
 \{ [ type \.{\mapsto} b\_item . type ,\, qtty \.{\mapsto} f\_item . qtty
 \.{+} b\_item . qtty ] \}}%
\@x{\@s{216.85} \.{\ELSE} fridge \.{\cup} \{ b\_item \} )}%
 \@x{\@s{160.30} \.{\land} bought\_items \.{'} \.{=} [ bought\_items {\EXCEPT}
 {\bang} [ self ] \.{=} bought\_items [ self ] \.{\,\backslash\,} \{ b\_item
 \} ]}%
 \@x{\@s{140.99} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{FillFridge} ]}%
 \@x{\@s{109.68} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{Client} ]}%
 \@x{\@s{140.99} \.{\land} {\UNCHANGED} {\langle} fridge ,\, bought\_items
 {\rangle}}%
 \@x{\@s{86.42} \.{\land} {\UNCHANGED} {\langle} recipe\_items ,\, n\_recipes
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ ChooseRecipe ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{ChooseRecipe}}%
 \@x{\@s{102.25} \.{\land} EnoughInFridgeForARecipe \.{\land}
 NoOtherUserInTheKitchen ( self )}%
 \@x{\@s{102.25} \.{\land} recipe\_items \.{'} \.{=} [ recipe\_items {\EXCEPT}
 {\bang} [ self ] \.{=} GetOneRecipe ]}%
 \@x{\@s{102.25} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{MakeRecipe} ]}%
 \@x{\@s{102.25} \.{\land} {\UNCHANGED} {\langle} fridge ,\, bought\_items ,\,
 n\_recipes {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ MakeRecipe ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{MakeRecipe}}%
\@x{\@s{94.86} \.{\land} {\IF} recipe\_items [ self ] \.{\neq} \{ \}}%
 \@x{\@s{118.13} \.{\THEN} \.{\land} \E\, r\_item \.{\in} recipe\_items [ self
 ] \.{:}}%
 \@x{\@s{168.75} \.{\land} fridge \.{'} \.{=} ( \.{\LET} f\_item \.{\defeq}
 {\CHOOSE} i \.{\in} fridge \.{:} i . type \.{=} r\_item . type}%
 \@x{\@s{245.70} new\_item \.{\defeq} [ type \.{\mapsto} r\_item . type ,\,
 qtty \.{\mapsto} f\_item . qtty \.{-} r\_item . qtty ]}%
 \@x{\@s{225.30} \.{\IN} ( fridge \.{\,\backslash\,} \{ f\_item \} ) \.{\cup}
 {\IF} new\_item . qtty \.{>} 0 \.{\THEN} \{ new\_item \} \.{\ELSE} \{ \} )}%
 \@x{\@s{168.75} \.{\land} recipe\_items \.{'} \.{=} [ recipe\_items {\EXCEPT}
 {\bang} [ self ] \.{=} recipe\_items [ self ] \.{\,\backslash\,} \{ r\_item
 \} ]}%
 \@x{\@s{149.44} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{MakeRecipe} ]}%
\@x{\@s{149.44} \.{\land} {\UNCHANGED} n\_recipes}%
 \@x{\@s{118.13} \.{\ELSE} \.{\land} n\_recipes \.{'} \.{=} [ n\_recipes
 {\EXCEPT} {\bang} [ self ] \.{=} n\_recipes [ self ] \.{+} 1 ]}%
 \@x{\@s{149.44} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Client} ]}%
 \@x{\@s{149.44} \.{\land} {\UNCHANGED} {\langle} fridge ,\, recipe\_items
 {\rangle}}%
\@x{\@s{94.86} \.{\land} {\UNCHANGED} bought\_items}%
\@pvspace{8.0pt}%
 \@x{ client ( self ) \.{\defeq} Client ( self ) \.{\lor} BuyIngredients (
 self ) \.{\lor} FillFridge ( self )}%
 \@x{\@s{80.11} \.{\lor}\@s{3.85} ChooseRecipe ( self ) \.{\lor} MakeRecipe (
 self )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, self \.{\in} USERS \.{:} client ( self ) )}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} \.{\land} Init \.{\land} {\Box} [ Next ]_{
 vars}}%
 \@x{\@s{39.83} \.{\land} \A\, self \.{\in} USERS \.{:} {\SF}_{ vars} ( client
 ( self ) )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} fridge \.{=} \{ \} \.{\lor} \A\, i \.{\in}
 fridge \.{:} i . type \.{\in} INGREDIENTS \.{\land} i . qtty \.{>} 0}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 PROPERTIES
...
\@xx{}%
 \@x{ BuysIngredientsInFridge \.{\defeq} \E\, self \.{\in} ProcSet \.{:} pc [
 self ] \.{=}\@w{BuyIngredients} \.{\leadsto} fridge \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
 \@x{ MakeRecipeHappens \.{\defeq} {\Diamond} ( \E\, self \.{\in} ProcSet
 \.{:} pc [ self ] \.{=}\@w{MakeRecipe} )}%
\@pvspace{24.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Jul} 21
 00:13:07 \ensuremath{CEST} 2024 by \ensuremath{davd33
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Jul} 17
 21:03:29 \ensuremath{CEST} 2024 by \ensuremath{davd33
}%
\end{cpar}%
\end{lcom}%
\end{document}
